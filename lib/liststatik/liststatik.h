...
typedef int listElType; /* type elemen List */
typedef int IdxType;
typedef struct
{
   listElType contents[CAPACITY]; /* memori tempat penyimpan elemen (container) */
} ListStatik;
/* Indeks yang digunakan [0..CAPACITY-1] */
/* Jika l adalah ListStatik, cara deklarasi dan akses: */
/* Deklarasi : l : ListStatik */
/* Maka cara akses:
   ELMT_L(l,i) untuk mengakses elemen ke-i */
/* Definisi :
   List kosong: semua elemen bernilai MARK
   Definisi elemen pertama: ELMT_L(l,i) dengan i=0 */

/* ********** SELEKTOR ********** */
#define ELMT_L(l, i) (l).contents[(i)]
