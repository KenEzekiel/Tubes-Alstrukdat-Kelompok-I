...
void InitializeVariables()
{
	...
	TIME waktu; CreateTime(&waktu, 0, 0, 0);
	Point lokasi; CreatePoint(&lokasi, 0, 0);
	PrioQueueTime inventory; MakeEmpty(&inventory, 100);
	Simulator BNMO; CreateStartSimulator(&BNMO, "BNMO");
